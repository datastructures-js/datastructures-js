...
class DoublyLinkedList extends LinkedList {
    ...
    /**
     * @private
     * removes the only node in the list
     */
    removeLonelyNode() {
        this.headNode = null;
        this.tailNode = null;
     ...
     */
    removeLast() {
        if (this.tailNode !== null && this.tailNode.getPrev() === null) {
            this.removeLonelyNode();
        }
        else if (this.tailNode !== null && this.tailNode.getPrev() !== null) {
