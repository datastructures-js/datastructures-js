...
class BinarySearchTree {
     ...
     */
    delete(value, parent = null, node = this.root) {
        if (node !== null) {
            if (value === node.getValue()) {
                if (node.getRight() === null && node.getLeft() === null) {
                    ...
                    this.delete(minRight.getValue(), node, node.getRight());
                }
            }
            else if (value < node.getValue()) {
                this.delete(value, node, node.getLeft());
            }
            else if (value > node.getValue()) {
                this.delete(value, node, node.getRight());
            }
        }
    }
